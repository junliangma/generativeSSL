...
l_bs, u_bs = 100,100
betaset, runs = [0.005], int(sys.argv[5])
...
np.save('./output/'+modelName+'_mc'+str(mc_samps)+'_test_loglikelihood.npy', test_ll)
np.save('./output/'+modelName+'_mc'+str(mc_samps)+'_test_accuracy.npy', test_ac)
